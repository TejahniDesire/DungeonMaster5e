...
class ItemHolder:
    ...
    def add_item(self, item: objectsDnD.Item, amount=1):
    ...
    def find_keys_of_item(self, query_item:str):
        return objectHelperTools.regexSearch(query_item, list(self.inventory))
    ...
    def __getitem__(self, item: str):
        item = objectHelperTools.name_to_key(item)
