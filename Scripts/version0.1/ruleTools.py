...
class Stat:
    ...
    def __init__(self, attribute: str):
        ...
        self.contrib_base = {} 
        self.total_bonus_val = 0 # numerical value of bonus
        self.total_base_val = 0 # numerical value of base 
        self.contrib_bonus = {
    ...
    def update(self):
        self.total_base_val = int(np.sum(list(self.contrib_base.values()))) # sum over all base contributions
        self.contrib_bonus['nat_stat'] = calc_bonus(self.total_base_val) # calculate bonus from base value
        self.total_bonus_val = int(np.sum(list(self.contrib_bonus.values()))) # sum over all bonus contributions 
...
class Skill:
    ...
    def update(self):
        ...
        if self.has_skill():
            ...
            self.contrib['prof'] = 0 # if skill is not had, no proffeciency bonus
