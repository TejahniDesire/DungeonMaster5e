...
class MainTab(QWidget):
    ...
    def __init__(self, tcharecter, *args, **kwargs):
        ...
        self.attribute_labels = pyqt5_Custom.AllStatWidgets(tcharecter)

        # top_layout_______________________________
        self.top_widget = pyqt5_Custom.RPWidget(tcharecter.get_all_top())

        # Mid_layout_______________________________
        mid_layout = QVBoxLayout()
        self.mid_widget = pyqt5_Custom.MiddleWidget(tcharecter.get_all_mid_top(), tcharecter.get_all_mid_mid())
        ...
        self.weapon_widget = pyqt5_Custom.WeaponWidget(
        ...
        self.rp_trait_widget = pyqt5_Custom.RPTraitWidget(tcharecter.get_all_rp_traits())
...
class Inventory(QWidget):
    ...
    def __init__(self, tcharecter, *args, **kwargs):
        ...
        self.inventory_widget = pyqt5_Custom.InventoryWidget(tcharecter.get_inventory())
...
class Options(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        saveButton = appHelperTools.CreateGenButton("Save", style.LabelFont1, style.SubButtonSheet, self.save, minWidth=400)
        ...
        options_sub_layout.addWidget(pyqt5_Custom.appHelperTools.CreateSeperator())
