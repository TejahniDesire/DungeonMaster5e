...
class DnDWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        refresh_button = appHelperTools.CreateGenButton(
        ...
        button_layout.addWidget(appHelperTools.CreateTabButton(self.switch_tab, 0, style.LabelFont2,
                                                    style.TabButtonSheet2, "Main Window"))
        button_layout.addWidget(appHelperTools.CreateTabButton(self.switch_tab, 1, style.LabelFont2,
                                                    style.TabButtonSheet2, "Features && Traits"))
        button_layout.addWidget(appHelperTools.CreateTabButton(self.switch_tab, 2, style.LabelFont2,
                                                    style.TabButtonSheet2, "Inventory"))
        button_layout.addWidget(appHelperTools.CreateTabButton(self.switch_tab, 3, style.LabelFont2,
